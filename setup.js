...
console.log(colors.green('    PROJECT SETUP SCRIPT'));
console.log(colors.green('    Samarth Event and Merchandise'));
console.log(colors.green('========================================'));
console.log();

// Google Drive file configurations

const ENV_FILES_CONFIG = [
  {
    fileId: '1IJFFiBKugjU0ANo-uJZokUql7VPg8OKg',
    fileName: '.env',
    destination: 'event/backend/.env',
    description: 'Event Backend Environment'
  },
  {
    fileId: '1xP4tQjUDzkmSdKA8ZalKwo28d22-PKxF',
    fileName: '.env',
    destination: 'event/client/.env',
    description: 'Event Client Environment'
  },
  {
    fileId: '1ZUZO1L6tYwWM71oIQReRODdzNTeiHeLG',
    fileName: '.env',
    destination: 'event/admin/.env',
    description: 'Event Admin Environment'
  },
  {
    fileId: '1hpXvE9WRB7UtvxO5UBWbF5ZUSpKGOYRl',
    fileName: '.env',
    destination: 'merch/backend/.env',
    description: 'Merch Backend Environment'
  },
  {
    fileId: '1gZwK1EK1cxUoCw1DjZrelucEcmgpWoP5',
    fileName: '.env',
    destination: 'merch/client/.env',
    description: 'Merch Client Environment'
  },
  {
    fileId: '1Raw91xZMizhe8uLHCTVVeZmHxbLMtE7s',
    fileName: '.env',
    destination: 'merch/admin/.env',
    description: 'Merch Admin Environment'
  }
];
...
function showCompletionMessage() {
  ...
  console.log(colors.green('========================================'));
  console.log();
  console.log(colors.yellow('To run your projects, use:'));
  console.log();
  console.log(colors.yellow('Environment files location:'));
  console.log();
  console.log(colors.cyan('  pnpm dev:event'));
  console.log(colors.cyan('  pnpm dev:merch'));
